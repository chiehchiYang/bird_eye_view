...
class MapMaskGenerator:
    ...
    def image_2_waypoints(self, image):
        ...
        with open("./maps/ori_MapBoundaries.json", 'r') as f:
            data = json.load(f)
    ...
    def _find_map_boundaries(self) -> MapBoundaries:
        ...
        if Generate_MapBoundaries:
            ...
            img_path = f"./maps/{self.Town}/mask_lane.png"
    ...
    def crosswalk_mask(self) -> Mask:
        ...
        img_path = f"./maps/{self.Town}/crosswalk.png"
    ...
    def road_line_mask(self) -> Mask:
        ...
        img_path = f"./maps/{self.Town}/mask_road_line.png"
